...
- (void)showNavigate{
    NSLog(@"开始导航");
    [(MapViewController *)_parentCtr showNavigate: self.annotation];
}
...
//            [self.calloutView addSubview:btn];
            ...
            UILabel *name = [[UILabel alloc] initWithFrame:CGRectMake(10, 5, 175, 30)];
            name.backgroundColor = [UIColor clearColor];
            name.textColor = [UIColor whiteColor];
            name.text = self.annotation.title;
             [self.calloutView addSubview:name];
            
            UILabel *subject = [[UILabel alloc] initWithFrame:CGRectMake(10, 25, 175, 30)];
            subject.backgroundColor = [UIColor clearColor];
            subject.textColor = [UIColor lightGrayColor];
            subject.text = self.annotation.subtitle;
            subject.adjustsFontSizeToFitWidth = true;
            [self.calloutView addSubview:subject];
            UITapGestureRecognizer *tap = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(showNavigate)];
